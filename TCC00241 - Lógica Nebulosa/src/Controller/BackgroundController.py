...
class BackgroundController:
    def __init__(self, surface, traffic_lights):
        ...
        self.fuzzy_button_color = self.black
    ...
    def draw_fuzzy_button(self):
        font = pygame.font.SysFont('Comic Sans MS', 16)
        text_surface = font.render('     Fuzzy     ', True, self.fuzzy_button_color)
    ...
    def change_color_fuzzy_button(self):
        if self.fuzzy_button_color == self.black: self.fuzzy_button_color = Config['colors']['traffic_green']
        else: self.fuzzy_button_color = self.black
