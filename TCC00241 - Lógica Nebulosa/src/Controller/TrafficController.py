...
class TrafficController:
    def __init__(self, surface):
        ...
        x = self.screen_width / 2 - self.traffic_light_distance_from_center[0] + 2.5*self.traffic_light_body_width
        y = self.screen_height / 2 + self.traffic_light_distance_from_center[1] - 2.5*self.traffic_light_body_height
    ...
    def calculate_fuzzy_score(self, arriving_green_light_car, behind_red_light_car, extension_count, isFuzzyOn):
        if isFuzzyOn: return self.fuzzy.get_extension(arriving_green_light_car, behind_red_light_car, extension_count)
        return 0
